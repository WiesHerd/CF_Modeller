...
/** Provider sample: header row + 2 example rows. Column order must match PROVIDER_EXPECTED_COLUMNS exactly. */
const PROVIDER_SAMPLE_HEADER = PROVIDER_EXPECTED_COLUMNS.join(',')

// Order must match PROVIDER_EXPECTED_COLUMNS: providerName, specialty, division, providerType, totalFTE, clinicalFTE, adminFTE, researchFTE, teachingFTE, adminPay, teachingPay, researchPay, baseSalary, workRVUs, outsideWRVUs, currentCF, nonClinicalPay, qualityPayments, otherIncentives, otherIncentive1, otherIncentive2, otherIncentive3, currentTCC, productivityModel
const PROVIDER_SAMPLE_ROWS = [
  'Jane Smith,Cardiology,Heart,Staff Physician,1,0.9,0.1,0,0,0,0,0,450000,5200,200,85,0,0,0,0,0,0,0,productivity',
  'John Doe,Internal Medicine,Primary Care,Advanced Practice Provider,1,0.95,0.05,0,0,0,0,0,320000,4100,100,78,0,0,0,0,0,0,0,base',
]
