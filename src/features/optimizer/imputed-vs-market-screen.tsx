...
import { ArrowLeft, ChevronLeft, ChevronRight, GripVertical, Columns3, BarChart2, LayoutList, ChevronDown, Info, FileDown, FileSpreadsheet, Pin, Eraser, ListChecks, Minimize2 } from 'lucide-react'
