  ...
  return (
    <div className="min-w-0 max-w-full space-y-8 overflow-hidden">
      ...
      <p className="text-muted-foreground text-sm">
        View, load, or clear saved model scenarios, batch runs, and batch scenario configs. Switch tabs to see each type. Loaded items apply in Single scenario or Batch.
      </p>
      ...
      <Tabs defaultValue={TAB_IDS.scenarios} className="min-w-0 flex flex-col">
        <TabsList className="w-full sm:w-auto grid grid-cols-3">
          ...
          <TabsTrigger value={TAB_IDS.batchRuns}>
            Saved batch runs{savedBatchRuns.length > 0 ? ` (${savedBatchRuns.length})` : ''}
          </TabsTrigger>
